 ...
 * @author ADVAN
 */
public class LaporanDataSupplier extends javax.swing.JInternalFrame {
...
private String sql="";
    ...
    public LaporanDataSupplier() {
       initComponents();
        ...
        setIconifiable(true); 
        setResizable(true);
        setTitle("Data Laporan Supplier");
    ...
    DefaultTableModel model = new DefaultTableModel(
        new Object[][]{},
        new String[]{"Kode Supplier", "Nama Supplier", "Barang", "Alamat", "Telp"}
    ) {
        @Override
    ...
    try {
        ...
        TabelS.setModel(model); // pastikan nama JTable = TabelS

    } catch (Exception e) {
        JOptionPane.showMessageDialog(null,
            "Gagal menampilkan data supplier: " + e.getMessage());
    }
}
    ...
    private void initComponents() {
        ...
        TabelS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Supplier", "Nama Supplier", "Jenis", "Alamat", "Telepon", "Harga"
            }
        ));
    ...
    JasperReport jr = JasperCompileManager.compileReport(
            "src/laporan/Data Supplier.jrxml"
    );
